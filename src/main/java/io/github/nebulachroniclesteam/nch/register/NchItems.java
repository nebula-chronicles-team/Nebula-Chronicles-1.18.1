...
public class NchItems {
    ...
    public static final RegistryObject<Item>
            // NCH_MISC_ITEMS
            WHITE_BUD_LEAVES = ITEMS.register("white_bud_leaves", () -> new Item(new Item.Properties().tab(NchCreativeModeTab.NCH_MISC_ITEMS))),
            WHITE_BUD_STEW = ITEMS.register("white_bud_stew", () -> new Item(new Item.Properties().tab(NchCreativeModeTab.NCH_MISC_ITEMS).food((new FoodProperties.Builder()).nutrition(6).saturationMod(0.3F).build()))),
            LANTERN_BERRIES = ITEMS.register("lantern_berries", () -> new Item(new Item.Properties().tab(NchCreativeModeTab.NCH_MISC_ITEMS).food((new FoodProperties.Builder()).nutrition(3).saturationMod(0.3F).effect(new MobEffectInstance(MobEffects.GLOWING, 300, 0), 1.0F).effect(new MobEffectInstance(MobEffects.NIGHT_VISION, 300, 0), 1.0F).build()))),
            BUG_FLESH = ITEMS.register("bug_flesh", () -> new Item(new Item.Properties().tab(NchCreativeModeTab.NCH_MISC_ITEMS).food((new FoodProperties.Builder()).nutrition(2).saturationMod(0.3F).build()))),
